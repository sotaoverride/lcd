...
parameter :
    ...
    color :   Set the color
******************************************************************************/
void LCD_1IN28_ClearWindow(UWORD Xstart, UWORD Ystart, UWORD Xend, UWORD Yend,UWORD color)
{          
  UWORD i,j; 
...
/******************************************************************************
function :	Sends the image buffer in RAM with the specified coordinates to the display
parameter:
******************************************************************************/
void LCD_1IN28_DisplayWindows(UWORD Xstart, UWORD Ystart, UWORD Xend, UWORD Yend, UWORD *Image)
{
	...
	Xstart -= 10;Xend += 10;
	Ystart -= 10;Yend += 10;
	Xstart = (Xstart < 255)? Xstart : 0;
	Ystart = (Ystart < 255)? Ystart : 0;
